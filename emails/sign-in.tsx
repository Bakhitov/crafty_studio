...
export const LoginEmailTemplate = ({
  ...
  <Html>
    <Head />
    <Preview>Your magic link to login to Crafty</Preview>
    <EmailLayout>
      <Text className="text-left text-[#525f7f] text-base leading-6">
        Hello there! Someone (hopefully you) requested to login to Crafty.
      </Text>
      <Text className="text-left text-[#525f7f] text-base leading-6">
        Click the button below to securely login to your Crafty account. No
        password needed!
      </Text>
      <Link
...
LoginEmailTemplate.PreviewProps = {
  magicLink: 'https://www.crafty.ai/login',
  email: 'test@test.com',
