...
const description =
  'These Terms of Service govern your use of the website and any related services provided by Crafty. By accessing any of the sites mentioned above, you agree to abide by these Terms of Service and to comply with all applicable laws and regulations.';
  ...
  <div className="relative grid w-full grid-cols-[0.2fr_3fr_0.2fr] md:grid-cols-[0.5fr_3fr_0.5fr]">
    ...
    <div className="relative flex items-center justify-center border-x border-b border-dotted">
      ...
      <div className="prose prose-primary dark:prose-invert py-12">
        ...
        <p>
          We, Crafty, reserve the right to review and amend any of these Terms of
        ...
        <p>
          ...
          are owned by or licensed to Crafty and are protected by applicable
        ...
        <p>
          ...
          restrictions or the Terms of Service, and may be terminated by Crafty
          at any time.
        </p>
        ...
        <p>
          ...
          is' basis. To the extent permitted by law, Crafty makes no warranties,
        ...
        <p>
          In no event shall Crafty or its suppliers be liable for any
          ...
          on this website, even if Crafty or an authorized representative has
        ...
        <p>
          ...
          for general information purposes only. Crafty does not warrant or make
        ...
        <h2>Links</h2>
        <p>
          Crafty has not reviewed all of the sites linked to its website and is
          ...
          by Crafty of the site. Use of any such linked site is at your own risk
