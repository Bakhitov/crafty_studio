...
const description =
  "Your privacy is important to us. It is Crafty's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website and other sites we own and operate.";
  ...
  <div className="relative grid w-full grid-cols-[0.2fr_3fr_0.2fr] md:grid-cols-[0.5fr_3fr_0.5fr]">
    ...
    <div className="relative flex items-center justify-center border-x border-b border-dotted">
      ...
      <div className="prose prose-primary dark:prose-invert py-12">
        ...
        <p>
          The Crafty Subprocessor List identifies subprocessors authorized to
          subprocess customer or personal data on behalf of Crafty to provide
        ...
        <p>
          ...
          organizations (known as “data processors”). We, Crafty, located at the
