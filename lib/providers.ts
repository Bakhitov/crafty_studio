...
export const developerIcons: Record<string, typeof OpenAiIcon> = {
  ...
  bytedance: ArkIcon,
  stabilityai: StabilityColorIcon,
  recraftai: RecraftColorIcon,
  tripoai: StabilityColorIcon,
  ...
  klingai: KlingColorIcon,
  replicate: ReplicateColorIcon,
  ...
  novita: NovitaIcon,
  aiml: UnknownIcon,
  ark: BytedanceColorIcon,
  vertex: VertexAiColorIcon,
  groq: GroqColorIcon,
  minimaxai: MinimaxColorIcon,
  hume: HumeIcon,
  lmnt: LmntIcon,
  blackforestlabs: BlackForestLabsIcon,
  deepseek: DeepseekColorIcon,
  runwayml: RunwayColorIcon,
  together: TogetherColorIcon,
  luma: LumaColorIcon,
  xai: XaiColorIcon,
  vercel: VercelColorIcon,
  unknown: UnknownIcon,
  pixverse: PixverseColorIcon,
};