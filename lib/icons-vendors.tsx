...
export const AnthropicColorIcon = makeAssetIcon('/demo/logoSVG/anthropic.svg', 'Anthropic');
export const MinimaxColorIcon = makeAssetIcon('/demo/logoSVG/minimax-color.svg', 'Minimax AI');
export const LumaColorIcon = makeAssetIcon('/demo/logoSVG/luma-color.svg', 'Luma');
export const RunwayColorIcon = makeAssetIcon('/demo/logoSVG/runway.svg', 'Runway ML');
export const ReplicateColorIcon = makeAssetIcon('/demo/logoSVG/replicate.svg', 'Replicate');
export const KlingColorIcon = makeAssetIcon('/demo/logoSVG/kling-color.svg', 'Kling AI');
...
export const GeminiColorIcon = makeAssetIcon('/demo/logoSVG/gemini-color.svg', 'Gemini');
...
export const StabilityColorIcon = makeAssetIcon('/demo/logoSVG/stability-color.svg', 'Stability AI');
export const RecraftColorIcon = makeAssetIcon('/demo/logoSVG/recraft.svg', 'Recraft AI');
export const PixverseColorIcon = makeAssetIcon('/demo/logoSVG/pixverse.svg', 'Pixverse');